...
public class TimeFrameIteratorAnyTime extends TimeFrameIterator {
	...
	public TimeFrameIteratorAnyTime(int days) {
		this.mode=1;
	...
	public TimeFrameIteratorAnyTime(Date initDate, Date endDate, int unitType, int amount) {
		this.mode=2;
