...
public interface GloriaRtiScheduler {
    ...
    public eu.gloria.rt.entity.scheduler.PlanSearchFilterResult planSearchByFilter(
        ...
        eu.gloria.rt.entity.scheduler.PlanSearchPagination pagination
    ) throws RtiSchError;
