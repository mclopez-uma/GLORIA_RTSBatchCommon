 ...
 *         &lt;element name="planList" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "planAdvertise")
public class PlanAdvertise {
     ...
     * This is why there is not a <CODE>set</CODE> method for the planList property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPlanList().add(newItem);
     * </pre>
     * 
     * 
     * <p>
